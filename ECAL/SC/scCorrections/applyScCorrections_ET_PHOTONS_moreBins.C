...
Double_t applyScCorrectionsET_EB(Double_t ET){  							   
  ...
  h_CBET_EB->SetBinContent(27, 0.999244); 
  h_CBET_EB->SetBinContent(29, 0.99959); 
  h_CBET_EB->SetBinContent(31, 1.00039); 
  h_CBET_EB->SetBinContent(33, 0.99991); 
  h_CBET_EB->SetBinContent(35, 1.00083); 
  Int_t iET      = -1;                                                                   
...
Double_t applyScCorrectionsET_EE(Double_t ET){  							   
  ...
  h_CBET_EE->SetBinContent(27, 1.00173); 
  h_CBET_EE->SetBinContent(29, 1.00233); 
  h_CBET_EE->SetBinContent(31, 1.00118); 
  h_CBET_EE->SetBinContent(33, 1.00467); 
  h_CBET_EE->SetBinContent(35, 1.00934); 
  Int_t iET      = -1;                                                                   
  for (Int_t iiET  = 0; iiET  < nBinsET;  ++iiET ){ 				      
    if ( leftET [iiET]  <= (ET)      &&       (ET) < rightET[iiET] ) {		      
      iET  = iiET;  								      

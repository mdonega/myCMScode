...
class scCorrections {
 public :
  ...
  Int_t           vtxNTrk[1];   //[nVtx]
  Int_t           vtxNDF[1];   //[nVtx]
  Float_t         vtxD0[1];   //[nVtx]
  Int_t           IsVtxGood;
  Int_t           nVtxBS;
  Float_t         vtxbs[1][3];   //[nVtxBS]
  Float_t         vtxbsPtMod[1];   //[nVtxBS]
  Float_t         vtxbsSumPt2[1];   //[nVtxBS]
  vector<vector<int> > *vtxbsTkIndex;
  vector<vector<float> > *vtxbsTkWeight;
  Int_t           nTrk;
  Float_t         trkP[46][3];   //[nTrk]
  Float_t         trkVtx[46][3];   //[nTrk]
  Float_t         trkd0[46];   //[nTrk]
  Float_t         trkd0Err[46];   //[nTrk]
  Float_t         trkdz[46];   //[nTrk]
  Float_t         trkdzErr[46];   //[nTrk]
  Float_t         trkPtErr[46];   //[nTrk]
  Int_t           trkQuality[46];   //[nTrk]
  Int_t           nGoodTrk;
  Int_t           IsTracksGood;
  Float_t         pdf[7];
  Float_t         pthat;
  ...
  Int_t           nMC;
  Int_t           mcPID[2];   //[nMC]
  Float_t         mcVtx[2][3];   //[nMC]
  Float_t         mcPt[2];   //[nMC]
  Float_t         mcMass[2];   //[nMC]
  Float_t         mcEta[2];   //[nMC]
  Float_t         mcPhi[2];   //[nMC]
  Float_t         mcE[2];   //[nMC]
  Float_t         mcEt[2];   //[nMC]
  Int_t           mcGMomPID[2];   //[nMC]
  Int_t           mcMomPID[2];   //[nMC]
  Float_t         mcMomPt[2];   //[nMC]
  Float_t         mcMomMass[2];   //[nMC]
  Float_t         mcMomEta[2];   //[nMC]
  Float_t         mcMomPhi[2];   //[nMC]
  Int_t           mcIndex[2];   //[nMC]
  Int_t           mcDecayType[2];   //[nMC]
  Float_t         mcCalIsoDR03[2];   //[nMC]
  Float_t         mcTrkIsoDR03[2];   //[nMC]
  Float_t         mcCalIsoDR04[2];   //[nMC]
  Float_t         mcTrkIsoDR04[2];   //[nMC]
  Float_t         genMET;
  Float_t         genMETx;
  Float_t         genMETy;
  Float_t         genMETPhi;
  ...
  Float_t         pfMETSig;
  Int_t           nEle;
  Int_t           eleTrg[2][13];   //[nEle]
  Int_t           eleID[2][12];   //[nEle]
  Int_t           eleClass[2];   //[nEle]
  Int_t           eleCharge[2];   //[nEle]
  Float_t         eleEn[2];   //[nEle]
  Float_t         eleSCRawEn[2];   //[nEle]
  Float_t         eleSCEn[2];   //[nEle]
  Float_t         elePt[2];   //[nEle]
  Float_t         eleEta[2];   //[nEle]
  Float_t         elePhi[2];   //[nEle]
  Float_t         eleSCEta[2];   //[nEle]
  Float_t         eleSCPhi[2];   //[nEle]
  Float_t         eleSCEtaWidth[2];   //[nEle]
  Float_t         eleSCPhiWidth[2];   //[nEle]
  Float_t         eleVtx[2][3];   //[nEle]
  Float_t         eleD0[2];   //[nEle]
  Float_t         eleDz[2];   //[nEle]
  Float_t         eleHoverE[2];   //[nEle]
  Float_t         eleEoverP[2];   //[nEle]
  Float_t         elePin[2];   //[nEle]
  Float_t         elePout[2];   //[nEle]
  Float_t         eleBrem[2];   //[nEle]
  Float_t         eledEtaAtVtx[2];   //[nEle]
  Float_t         eledPhiAtVtx[2];   //[nEle]
  Float_t         eleSigmaIEtaIEta[2];   //[nEle]
  Float_t         eleSigmaIEtaIPhi[2];   //[nEle]
  Float_t         eleSigmaIPhiIPhi[2];   //[nEle]
  Float_t         eleEmax[2];   //[nEle]
  Float_t         eleE3x3[2];   //[nEle]
  Float_t         eleE5x5[2];   //[nEle]
  Float_t         eleE2x5Right[2];   //[nEle]
  Float_t         eleE2x5Left[2];   //[nEle]
  Float_t         eleE2x5Top[2];   //[nEle]
  Float_t         eleE2x5Bottom[2];   //[nEle]
  Float_t         eleSeedTime[2];   //[nEle]
  Int_t           eleRecoFlag[2];   //[nEle]
  Int_t           eleGenIndex[2];   //[nEle]
  Int_t           eleGenGMomPID[2];   //[nEle]
  Int_t           eleGenMomPID[2];   //[nEle]
  Float_t         eleGenMomPt[2];   //[nEle]
  Float_t         eleIsoTrkDR03[2];   //[nEle]
  Float_t         eleIsoEcalDR03[2];   //[nEle]
  Float_t         eleIsoHcalDR03[2];   //[nEle]
  Float_t         eleIsoHcalSolidDR03[2];   //[nEle]
  Float_t         eleIsoTrkDR04[2];   //[nEle]
  Float_t         eleIsoEcalDR04[2];   //[nEle]
  Float_t         eleIsoHcalDR04[2];   //[nEle]
  Float_t         eleIsoHcalSolidDR04[2];   //[nEle]
  Int_t           eleMissHits[2];   //[nEle]
  Float_t         eleConvDist[2];   //[nEle]
  Float_t         eleConvDcot[2];   //[nEle]
  Float_t         eleESEffSigmaRR[2][3];   //[nEle]
  Float_t         eleESE1[2][2];   //[nEle]
  Float_t         eleESE3[2][2];   //[nEle]
  Float_t         eleESE5[2][2];   //[nEle]
  Float_t         eleESE7[2][2];   //[nEle]
  Float_t         eleESE11[2][2];   //[nEle]
  Float_t         eleESE21[2][2];   //[nEle]
  Float_t         eleBrLinear[2];   //[nEle]
  Float_t         eleCetaCorrE[2];   //[nEle]
  Float_t         eleCetaCorrEt[2];   //[nEle]
  Float_t         eleBremCorrE[2];   //[nEle]
  Float_t         eleBremCorrEt[2];   //[nEle]
  Float_t         eleFullCorrE[2];   //[nEle]
  Float_t         eleFullCorrEt[2];   //[nEle]
  Int_t           nPho;
  Int_t           phoTrg[3][8];   //[nPho]
  Bool_t          phoIsPhoton[3];   //[nPho]
  Float_t         phoCaloPos[3][3];   //[nPho]
  Float_t         phoE[3];   //[nPho]
  Float_t         phoEt[3];   //[nPho]
  Float_t         phoEta[3];   //[nPho]
  Float_t         phoVtx[3][3];   //[nPho]
  Float_t         phoPhi[3];   //[nPho]
  Float_t         phoEtVtx[3][50];   //[nPho]
  Float_t         phoEtaVtx[3][50];   //[nPho]
  Float_t         phoPhiVtx[3][50];   //[nPho]
  Float_t         phoR9[3];   //[nPho]
  Float_t         phoCetaCorrE[3];   //[nPho]
  Float_t         phoCetaCorrEt[3];   //[nPho]
  Float_t         phoBremCorrE[3];   //[nPho]
  Float_t         phoBremCorrEt[3];   //[nPho]
  Float_t         phoFullCorrE[3];   //[nPho]
  Float_t         phoFullCorrEt[3];   //[nPho]
  Float_t         phoTrkIsoSolidDR03[3];   //[nPho]
  Float_t         phoTrkIsoHollowDR03[3];   //[nPho]
  Float_t         phoEcalIsoDR03[3];   //[nPho]
  Float_t         phoHcalIsoDR03[3];   //[nPho]
  Float_t         phoHcalIsoSolidDR03[3];   //[nPho]
  Float_t         phoTrkIsoSolidDR04[3];   //[nPho]
  Float_t         phoTrkIsoHollowDR04[3];   //[nPho]
  Float_t         phoTrkIsoHollowNoDzDR03[3];   //[nPho]
  Float_t         phoTrkIsoHollowNoDzDR04[3];   //[nPho]
  Float_t         phoCiCTrkIsoDR03[3][50];   //[nPho]
  Float_t         phoCiCTrkIsoDR04[3][50];   //[nPho]
  Float_t         phoCiCdRtoTrk[3];   //[nPho]
  Float_t         phoEcalIsoDR04[3];   //[nPho]
  Float_t         phoHcalIsoDR04[3];   //[nPho]
  Float_t         phoHcalIsoSolidDR04[3];   //[nPho]
  Float_t         phoHoverE[3];   //[nPho]
  Float_t         phoSigmaIEtaIEta[3];   //[nPho]
  Float_t         phoSigmaIEtaIPhi[3];   //[nPho]
  Float_t         phoSigmaIPhiIPhi[3];   //[nPho]
  Float_t         phoEmax[3];   //[nPho]
  Float_t         phoE3x3[3];   //[nPho]
  Float_t         phoE5x5[3];   //[nPho]
  Float_t         phoE2x5Right[3];   //[nPho]
  Float_t         phoE2x5Left[3];   //[nPho]
  Float_t         phoE2x5Top[3];   //[nPho]
  Float_t         phoE2x5Bottom[3];   //[nPho]
  Float_t         phoSeedTime[3];   //[nPho]
  Int_t           phoSeedDetId1[3];   //[nPho]
  Int_t           phoSeedDetId2[3];   //[nPho]
  Int_t           phoRecoFlag[3];   //[nPho]
  Int_t           phoPos[3];   //[nPho]
  Int_t           phoGenIndex[3];   //[nPho]
  Int_t           phoGenGMomPID[3];   //[nPho]
  Int_t           phoGenMomPID[3];   //[nPho]
  Float_t         phoGenMomPt[3];   //[nPho]
  Float_t         phoSCE[3];   //[nPho]
  Float_t         phoSCRawE[3];   //[nPho]
  Float_t         phoESEn[3];   //[nPho]
  Float_t         phoSCEt[3];   //[nPho]
  ...
  Int_t           phoOverlap[3];   //[nPho]
  Int_t           phohasPixelSeed[3];   //[nPho]
  Int_t           phoIsConv[3];   //[nPho]
  Int_t           phoNConv[3];   //[nPho]
  Float_t         phoConvInvMass[3];   //[nPho]
  Float_t         phoConvCotTheta[3];   //[nPho]
  Float_t         phoConvEoverP[3];   //[nPho]
  Float_t         phoConvZofPVfromTrks[3];   //[nPho]
  Float_t         phoConvMinDist[3];   //[nPho]
  Float_t         phoConvdPhiAtVtx[3];   //[nPho]
  Float_t         phoConvdPhiAtCalo[3];   //[nPho]
  Float_t         phoConvdEtaAtCalo[3];   //[nPho]
  Float_t         phoConvTrkd0[3][2];   //[nPho]
  Float_t         phoConvTrkPin[3][2];   //[nPho]
  Float_t         phoConvTrkPout[3][2];   //[nPho]
  Float_t         phoConvTrkdz[3][2];   //[nPho]
  Float_t         phoConvTrkdzErr[3][2];   //[nPho]
  Float_t         phoConvChi2[3];   //[nPho]
  Float_t         phoConvChi2Prob[3];   //[nPho]
  Float_t         phoConvCharge[3][2];   //[nPho]
  Float_t         phoConvValidVtx[3];   //[nPho]
  Float_t         phoConvLikeLihood[3];   //[nPho]
  Float_t         phoConvP4[3][4];   //[nPho]
  Float_t         phoConvVtx[3][3];   //[nPho]
  Float_t         phoConvVtxErr[3][3];   //[nPho]
  Float_t         phoConvPairMomentum[3][3];   //[nPho]
  Float_t         phoConvRefittedMomentum[3][3];   //[nPho]
  Float_t         phoESEffSigmaRR[3][3];   //[nPho]
  Float_t         phoESE1[3][2];   //[nPho]
  Float_t         phoESE3[3][2];   //[nPho]
  Float_t         phoESE5[3][2];   //[nPho]
  Float_t         phoESE7[3][2];   //[nPho]
  Float_t         phoESE11[3][2];   //[nPho]
  Float_t         phoESE21[3][2];   //[nPho]
  Int_t           nMu;
  Int_t           muTrg[1][6];   //[nMu]
  Float_t         muEta[1];   //[nMu]
  Float_t         muPhi[1];   //[nMu]
  Int_t           muCharge[1];   //[nMu]
  Float_t         muPt[1];   //[nMu]
  Float_t         muPz[1];   //[nMu]
  Int_t           muGenIndex[1];   //[nMu]
  Float_t         muIsoTrk[1];   //[nMu]
  Float_t         muIsoCalo[1];   //[nMu]
  Float_t         muIsoEcal[1];   //[nMu]
  Float_t         muIsoHcal[1];   //[nMu]
  Float_t         muChi2NDF[1];   //[nMu]
  Float_t         muEmVeto[1];   //[nMu]
  Float_t         muHadVeto[1];   //[nMu]
  Int_t           muType[1];   //[nMu]
  Bool_t          muID[1][6];   //[nMu]
  Float_t         muD0[1];   //[nMu]
  Float_t         muDz[1];   //[nMu]
  Int_t           muNumberOfValidTrkHits[1];   //[nMu]
  Int_t           muNumberOfValidPixelHits[1];   //[nMu]
  Int_t           muNumberOfValidMuonHits[1];   //[nMu]
  Int_t           muStations[1];   //[nMu]
  Int_t           muChambers[1];   //[nMu]
  Int_t           nPFPho_;
  ...
  Float_t         rho44;
  Int_t           nJet;
  Int_t           jetTrg[2][14];   //[nJet]
  Float_t         jetEn[2];   //[nJet]
  Float_t         jetPt[2];   //[nJet]
  Float_t         jetEta[2];   //[nJet]
  Float_t         jetPhi[2];   //[nJet]
  Float_t         jetEt[2];   //[nJet]
  Float_t         jetRawPt[2];   //[nJet]
  Float_t         jetRawEn[2];   //[nJet]
  Float_t         jetCHF[2];   //[nJet]
  Float_t         jetNHF[2];   //[nJet]
  Float_t         jetCEF[2];   //[nJet]
  Float_t         jetNEF[2];   //[nJet]
  Int_t           jetNCH[2];   //[nJet]
  Float_t         jetHFHAE[2];   //[nJet]
  Float_t         jetHFEME[2];   //[nJet]
  Int_t           jetNConstituents[2];   //[nJet]
  Float_t         jetTrackCountHiEffBJetTags[2];   //[nJet]
  Float_t         jetTrackCountHiPurBJetTags[2];   //[nJet]
  Float_t         jetSimpleSVHiEffBJetTags[2];   //[nJet]
  Float_t         jetSimpleSVHiPurBJetTags[2];   //[nJet]
  Int_t           jetPartonID[2];   //[nJet]
  Int_t           jetGenJetIndex[2];   //[nJet]
  Float_t         jetGenJetEn[2];   //[nJet]
  Float_t         jetGenJetPt[2];   //[nJet]
  Float_t         jetGenJetEta[2];   //[nJet]
  Float_t         jetGenJetPhi[2];   //[nJet]
  Int_t           jetGenPartonID[2];   //[nJet]
  Float_t         jetGenEn[2];   //[nJet]
  Float_t         jetGenPt[2];   //[nJet]
  Float_t         jetGenEta[2];   //[nJet]
  Float_t         jetGenPhi[2];   //[nJet]
  Int_t           nZee;
  Float_t         ZeeMass[1];   //[nZee]
  Float_t         ZeePt[1];   //[nZee]
  Float_t         ZeeEta[1];   //[nZee]
  Float_t         ZeePhi[1];   //[nZee]
  Int_t           ZeeLeg1Index[1];   //[nZee]
  Int_t           ZeeLeg2Index[1];   //[nZee]
  Int_t           nZmumu;
  ...
  Int_t           nWenu;
  Float_t         WenuMassTPfMET[2];   //[nWenu]
  Float_t         WenuEtPfMET[2];   //[nWenu]
  Float_t         WenuACopPfMET[2];   //[nWenu]
  Int_t           WenuEleIndex[2];   //[nWenu]
  Int_t           nWmunu;
  Float_t         WmunuMassTPfMET[1];   //[nWmunu]
  Float_t         WmunuEtPfMET[1];   //[nWmunu]
  Float_t         WmunuACopPfMET[1];   //[nWmunu]
  Int_t           WmunuMuIndex[1];   //[nWmunu]
  Int_t           nConv;
  Float_t         convP4[85][4];   //[nConv]
  Float_t         convVtx[85][3];   //[nConv]
  Float_t         convVtxErr[85][3];   //[nConv]
  Float_t         convPairMomentum[85][3];   //[nConv]
  Float_t         convRefittedMomentum[85][3];   //[nConv]
  Int_t           convNTracks[85];   //[nConv]
  Float_t         convPairInvMass[85];   //[nConv]
  Float_t         convPairCotThetaSep[85];   //[nConv]
  Float_t         convEoverP[85];   //[nConv]
  Float_t         convDistOfMinApproach[85];   //[nConv]
  Float_t         convDPhiTrksAtVtx[85];   //[nConv]
  Float_t         convDPhiTrksAtEcal[85];   //[nConv]
  Float_t         convDEtaTrksAtEcal[85];   //[nConv]
  Float_t         convDxy[85];   //[nConv]
  Float_t         convDz[85];   //[nConv]
  Float_t         convLxy[85];   //[nConv]
  Float_t         convLz[85];   //[nConv]
  Float_t         convZofPrimVtxFromTrks[85];   //[nConv]
  Int_t           convNHitsBeforeVtx[85][2];   //[nConv]
  Int_t           convNSharedHits[85];   //[nConv]
  Int_t           convValidVtx[85];   //[nConv]
  Float_t         convMVALikelihood[85];   //[nConv]
  Float_t         convChi2[85];   //[nConv]
  Float_t         convChi2Probability[85];   //[nConv]
  Float_t         convTk1Dz[85];   //[nConv]
  Float_t         convTk2Dz[85];   //[nConv]
  Float_t         convTk1DzErr[85];   //[nConv]
  Float_t         convTk2DzErr[85];   //[nConv]
  Int_t           convCh1Ch2[85];   //[nConv]
  Float_t         convTk1D0[85];   //[nConv]
  Float_t         convTk1Pout[85];   //[nConv]
  Float_t         convTk1Pin[85];   //[nConv]
  Float_t         convTk2D0[85];   //[nConv]
  Float_t         convTk2Pout[85];   //[nConv]
  Float_t         convTk2Pin[85];   //[nConv]
